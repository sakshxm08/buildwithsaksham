...
func init() {
	...
	rootCmd.SetVersionTemplate("Devault - Build With Saksham")
...
If you've never run Devault by Build With Saksham, you'll need to have a database for
...
Also, if the database path doesn't exist, Devault will enter into
